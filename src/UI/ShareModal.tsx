import { MessageText, Telegram, Twitter, Pinterest, PasteClipboard, Cancel, CheckCircledOutline } from "iconoir-react";
            ...
            <div className={styles.modalBody}>
                {copiedClipboard
                    ...
                    : <div className={styles.buttonsContainer}>
                        <div> <ShareModalButton onClick={() => handleShare("Clipboard")} title={"Clipboard"}> <PasteClipboard {...SHAREICONPROPS} /></ShareModalButton></div>
